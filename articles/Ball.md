...
```
    ...
    # replicates = 99, weight: constant
    # bcov.constant = 0.0016845, p-value = 0.01
...
```
    ...
    # bcov.probability = 0.035512, p-value = 0.07
    # alternative hypothesis: random variables are dependent
...
```
    ...
    # kbd.sum.constant = 0.049675, p-value = 0.22
    # alternative hypothesis: distributions of samples are distinct
...
```
    ...
    # bcov.constant = 0.0019586, p-value = 0.005
    # alternative hypothesis: random variables are dependent
...
```
    ...
    # number of observations = 50
    # replicates = 199, weight: constant
    # bcov.constant = 0.04214, p-value = 0.005
    # alternative hypothesis: random variables are dependent
