...
On Windows, Ball supports compilation with MinGW. You need to install
`MinGW <https://sourceforge.net/projects/mingw/>`_.
Next, you should clone or download the Ball repo.
Then run the following from the root of the Ball directory::

    sh configure.sh your_python_path your_python_version_number
    # e.g. sh configure.sh C:/anaconda3 35
